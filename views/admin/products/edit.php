...
<body>
    ...
    <div class="container my-5">
        ...
        <form action="<?php echo BASE_URL; ?>app/product/update_product.php"
        method="POST" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="mt-3">
                    <img id="imagePreview" src="<?php echo BASE_URL.$product["image_url"]; ?>" alt="Image Preview" class="img-fluid"
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="unitPrice" name="unitPrice" placeholder="Enter unit price"
                            oninput="calculateTotalPrice()" value="<?php echo $product["unit_price"] ?>">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            placeholder="Total Price" readonly value="<?php echo $product["total_price"] ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-grid gap-2">
                            <a href="<?php echo BASE_URL; ?>views/admin/products/index.php" class="btn btn-secondary">Cancel</a>
                        </div>
